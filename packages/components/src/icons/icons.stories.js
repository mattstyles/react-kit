...
import { Text, View, FlexBox } from '../'
import { Surround, palette } from '../storybook'
  ...
  .add('Icons', () => (
    <View>
      ...
      <Surround>
        ...
        <Icon icon='SETTINGS' color={palette.orange[3]} hover={palette.red[7]} />
      </Surround>
      <Surround>
        <Text>Custom Icon Set</Text>
        <Icon icon='test' getIcon={getCustomIcon} color={palette.violet[6]} />
      </Surround>
      <Surround>
